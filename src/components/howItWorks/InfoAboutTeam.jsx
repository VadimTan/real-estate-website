...
export const InfoAboutTeam = () => {
	return (
		<section
			id="about-us"
			className="w-[836px] phone:w-[530px] smtablet:px-[70px] h-fit relative flex-shrink-0 rounded-[24px] bg-[#2C2C2E] flex flex-col items-center my-[160px] phone:mt-[60px] phone:mb-[100px]">
			<div className="flex">
				<img
			...
			<div
				id="text-about-us"
				className="flex absolute tablet:right-[0px] tablet:top-[475px] tablet:-bottom-[125px] tablet:w-full -right-20 top-20 w-[320px] p-[24px] justify-center gap-[8px] bg-[#ffffff] rounded-[16px] shadow-[10px_10px_10px_0px_rgba(0,0,0,0.03)]">
